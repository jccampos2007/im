...
$(document).ready(function(){
	...
	var table = $('#tblVUESupInbox').DataTable({		
		"sDom": 'ltipr',
		"processing": true,
		"serverSide" : true,
		"lenthChange" : false,
		"iDisplayLength" : 10,
		"autoWidth": false,
		"sAjaxSource" : "/find/request/0/na/na/0/na/na/Registro/2/",
		"buttons": [
			{
				extend:    'excelHtml5',
	...
	$('#tblVUESupInbox tbody').on( 'click','#btnAssignOfficial',function (e) {
	...
	$( "#btnVUESupAssignOfficial" ).click(function() {
			    ...
			    success: function(data) {
					...
					$.ajax({
					    ...
					    success: function(data) {
					    	...
					    	table.ajax.url("/find/request/0/na/na/0/na/na/Registro/2/").load();
