...
<div class="row">
    ...
    <div id="divSupInbox" class="col-md-12 col-sm-12 col-xs-12">
     <div class="x_panel tile">
       <div class="x_title">
         <h2><spring:message code="requestVUF.sup.panel.titleInbox" text="Bandeja"/></h2>
         <div class="clearfix"></div>
       </div>
       <div class="x_content">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
            	<table id="tblSupInbox"  class="table table-striped">
            		<thead>
            			<tr>
            				<td>id_request</td>
    ...
    <div class="modal-content">
	  <form id="formSupAssignOfficial" method="POST">
	    ...
	    <div class="modal-footer">
	      ...
	      <button type="button" id="btnSupAssignOfficial" class="btn btn-primary"><spring:message text="Enviar"/></button><!--  code="btn.delete.title"  -->
	    </div>
      </form>
    </div>
  </div>
