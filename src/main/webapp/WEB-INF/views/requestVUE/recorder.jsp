		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<form id="formVUERecControlReport" action="" method="POST">
					<div class="row">
				        <div class="form-group col-sm-4">
		              		<label for="inputVUERecNumberRequest" class="text-muted"><spring:message code="RequestVUF.lbl.nroRequest" text="N° Solicitud"/></label>
			              	<input class="form-control" name="inputVUERecNumberRequest" id="inputVUERecNumberRequest" type="text" required>
				        </div>
				        <div class="form-group col-sm-4">
		              		<label for="inputVUERecDateRequest" class="text-muted"><spring:message code="RequestVUF.lbl.dateRequest" text="Fecha Solicitud"/></label>
				        ...
				        <div class="form-group col-sm-4">
		              		<label for="selVUERecIdTypeUse" class="text-muted"><spring:message code="RequestVUF.lbl.typeUse" text="Uso Presentado"/></label>
					...
					<div class="row">
				        <div class="form-group col-sm-6">
		              		<label for="inputVUERecNumberCatastro" class="text-muted"><spring:message code="RequestVUF.lbl.numberCatastro" text="N° Catastro"/></label>
				        ...
				        <div class="form-group col-sm-6">
		              		<label for="inputVUERecNumberCatastroOld" class="text-muted"><spring:message code="RequestVUF.lbl.numberCatastroOld" text="N° Catastro Anterior"/></label>
					...
					<div class="row">
				        <div class="form-group col-sm-12">
		              		<label for="inputVUERecAdress" class="text-muted"><spring:message code="RequestVUF.lbl.adress" text="Dirección"/></label>
					...
					<div class="row">
				        ...
				        <div class="form-group col-sm-2">
		              		<label for="inputVUERecFee" class="text-muted"><spring:message code="RequestVUF.lbl.responsable" text="VANSAT"/></label>
				        ...
				        <div class="form-group col-sm-12">
							  ...
							  <tbody>
							    <tr>
							        ...
							        <th><input type="radio" value="yes" /></th>
									<th><input type="radio" value="no" /></th>
									<th><input type="radio" value="does_not_apply" /></th>
							    </tr>
							    <tr>
